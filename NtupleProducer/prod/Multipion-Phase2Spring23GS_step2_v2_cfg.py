...
# with command line options: --python_filename TSG-Phase2Spring23DIGIRECOMiniAOD-00139_1_cfg.py --eventcontent FEVTDEBUGHLT --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI-RAW --fileout file:TSG-Phase2Spring23DIGIRECOMiniAOD-00139_0.root --conditions 131X_mcRun4_realistic_v9 --step DIGI:pdigi_valid,L1TrackTrigger,L1,DIGI2RAW,HLT:@relval2026 --geometry Extended2026D95 --nStreams 3 --filein file:TSG-Phase2Spring23GS-00135.root --era Phase2C17I13M9 --no_exec --mc -n 100
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:TSG-Phase2Spring23GS-00135.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:multipion_phase2_digirecominiaod_pu0.root'),
